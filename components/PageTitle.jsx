        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 my-12">
            ...
            {linkText && (
                <Link 
                    href={path} 
                    prefetch={false}
                    className="group inline-flex items-center gap-4 text-rose-600 font-bold uppercase tracking-widest text-[10px] hover:text-rose-700 transition-all whitespace-nowrap"
                >
                    {linkText}
