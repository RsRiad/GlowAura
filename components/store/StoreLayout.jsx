            ...
            <div className="min-h-screen relative flex items-center justify-center p-6 bg-[#fff1f2] overflow-hidden">
                ...
                <div className="w-full max-w-md animate-reveal">
                    ...
                    <div className="flex flex-col items-center mb-10 text-center">
                        <Link href="/" className="relative text-5xl font-black text-slate-800 italic tracking-tighter mb-4">
                            <span className="text-rose-600">Glow</span>Aura<span className="text-rose-600 text-6xl leading-0">.</span>
                        ...
                        <p className="text-slate-400 font-medium italic text-sm max-w-xs">
                            Manage your collection and grow your business with executive style.
                        </p>
                    </div>
                    ...
                    <div className="mt-8 flex justify-center">
                        <Link href="/" className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-rose-600 transition-all group">
