    ...
    return (
        <div className="inline-flex h-full flex-col gap-5 border-r border-rose-100 bg-white/50 sm:min-w-64">
            <div className="flex flex-col gap-3 justify-center items-center pt-10 max-sm:hidden">
                <div className="relative p-1 bg-gradient-to-tr from-rose-200 to-amber-100 rounded-full shadow-lg shadow-rose-900/5">
                    <Image className="w-16 h-16 rounded-full border-2 border-white" src={storeInfo?.logo} alt="" width={100} height={100} />
                </div>
                <p className="text-slate-800 font-bold italic tracking-tight">{storeInfo?.name}</p>
            </div>
