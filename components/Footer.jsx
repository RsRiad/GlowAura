...
const Footer = () => {
  ...
  return (
    <HydrationGuard>
      <footer className="mt-32 border-t border-rose-100/50 bg-white">
        <div className="max-w-7xl mx-auto px-6 py-24">
          ...
          <div className="mt-24 pt-10 border-t border-rose-100/50 flex flex-col md:flex-row justify-between items-center gap-6">
