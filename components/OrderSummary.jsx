        ...
        <div className='w-full bg-rose-950 text-white rounded-[3.5rem] p-10 shadow-[0_30px_100px_-15px_rgba(159,18,57,0.3)] relative overflow-hidden animate-reveal'>
            ...
            <div className='relative z-10 space-y-10'>
                ...
                {isSignedIn ? (
                    ...
                    <button 
                        onClick={() => openSignIn()} 
                        className='premium-button w-full py-6 text-lg relative group overflow-hidden shadow-[0_20px_40px_-10px_rgba(244,63,94,0.4)] transform hover:scale-[1.02] active:scale-[0.98] transition-all bg-white text-rose-950 hover:bg-rose-50'
                    >
                        <span className='relative z-10 font-black uppercase tracking-[0.3em] text-rose-950'>Login to Checkout</span>
                        <div className='absolute inset-0 bg-gradient-to-r from-transparent via-rose-100/30 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000'></div>
                    </button>
                )}
            </div>
