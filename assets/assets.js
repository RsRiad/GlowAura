...
import hero_model_img from "./hero_model_new.png"
import hero_product_img1 from "./hero_product_new1.png"
import hero_product_img2 from "./hero_product_new2.png"
...
export const categories = ["Fragrance", "Skin Care", "Hair Care", "Jewellery", "Makeup", "Personal Care"];

export const dummyRatingsData = [
    { id: "rat_1", rating: 4.2, review: "I was a bit skeptical at first, but this product turned out to be even better than I imagined. The quality feels premium, it's easy to use, and it delivers exactly what was promised. I've already recommended it to friends and will definitely purchase again in the future.", user: { name: 'Kristin Watson', image: profile_pic1 }, productId: "prod_1", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Rose Petal Serum', category:'Skin Care', id:'prod_1'} },
    { id: "rat_2", rating: 5.0, review: "This product is great. I love it! My skin feels so much softer and more radiant after just a week of use.", user: { name: 'Jenny Wilson', image: profile_pic2 }, productId: "prod_2", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Velvet Matte Lipstick', category:'Makeup', id:'prod_2'} },
    { id: "rat_3", rating: 4.1, review: "This product is amazing. The fragrance lasts all day and I get so many compliments whenever I wear it.", user: { name: 'Bessie Cooper', image: profile_pic3 }, productId: "prod_3", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Midnight Bloom Perfume', category:'Fragrance', id:'prod_3'} },
    { id: "rat_4", rating: 5.0, review: "Absolutely love this! The packaging is gorgeous and the product itself is top quality. Worth every penny.", user: { name: 'Kristin Watson', image: profile_pic1 }, productId: "prod_4", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Gold Pearl Necklace', category:'Jewellery', id:'prod_4'} },
    { id: "rat_5", rating: 4.3, review: "Overall, I'm very happy with this purchase. It works as described and feels luxurious. The only reason I didn't give it five stars is because the packaging was slightly damaged. Still, highly recommend it for anyone looking for a premium hair care solution.", user: { name: 'Jenny Wilson', image: profile_pic2 }, productId: "prod_5", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Silk Repair Hair Mask', category:'Hair Care', id:'prod_5'} },
    { id: "rat_6", rating: 5.0, review: "Best personal care product I have ever used. It leaves my skin feeling fresh and rejuvenated all day long.", user: { name: 'Bessie Cooper', image: profile_pic3 }, productId: "prod_6", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Lavender Body Wash', category:'Personal Care', id:'prod_6'} },
]
...
export const productDummyData = [
    {
        id: "prod_1",
        name: "Rose Petal Glow Serum",
        description: "A luxurious rose-infused serum that deeply hydrates and brightens your skin. Formulated with pure rose extract and hyaluronic acid for a radiant, dewy complexion. Suitable for all skin types.",
        mrp: 40,
        price: 29,
    ...
    },
    {
        ...
        description: "A long-lasting velvet matte lipstick with rich pigmentation. Infused with vitamin E for smooth application and comfortable all-day wear.",
        mrp: 50,
        price: 29,
        images: [product_img2],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "An enchanting floral fragrance with notes of jasmine, vanilla, and musk. Perfect for evening occasions. Long-lasting scent that captivates.",
        mrp: 60,
        price: 45,
        images: [product_img3],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "An elegant gold-plated necklace adorned with freshwater pearls. Handcrafted with precision for a timeless look that complements any outfit.",
        mrp: 70,
        price: 49,
        images: [product_img4],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "A deep-conditioning hair mask enriched with argan oil and keratin. Restores damaged hair, adds shine, and leaves locks silky smooth.",
        mrp: 49,
        price: 35,
        images: [product_img5],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "A calming lavender-scented body wash that gently cleanses and moisturizes. Made with natural ingredients for a spa-like shower experience.",
        mrp: 59,
        price: 39,
        images: [product_img6],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Stunning cubic zirconia stud earrings set in sterling silver. A classic accessory that adds sparkle to any look. Hypoallergenic and lightweight.",
        mrp: 89,
        price: 59,
        images: [product_img7],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "A lightweight yet deeply moisturizing face cream with SPF 30. Enriched with aloe vera and vitamin C for a fresh, protected complexion.",
        mrp: 99,
        price: 69,
        images: [product_img8],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "A lightweight argan oil serum that tames frizz, adds shine, and protects against heat damage. Perfect for all hair types.",
        mrp: 89,
        price: 55,
        images: [product_img9],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "A sophisticated floral fragrance blending rose, peony, and sandalwood. Long-lasting and perfect for everyday elegance.",
        mrp: 179,
        price: 129,
    ...
    {
        id: "prod_11",
        name: "Glow Palette Eyeshadow",
        description: "A 12-shade eyeshadow palette with matte and shimmer finishes. Highly pigmented, blendable, and long-lasting for stunning eye looks.",
        mrp: 39,
        price: 29,
    ...
    },
    {
        ...
        description: "A rich and nourishing body lotion infused with coconut milk and shea butter. Deeply hydrates and leaves skin feeling silky soft all day.",
        mrp: 199,
        price: 149,
